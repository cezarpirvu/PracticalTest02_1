					...
					if (city != null && !city.isEmpty() && informationType != null && !informationType.isEmpty()) {
						if (data.containsKey(city)) {
							...
							if (pageSourceCode != null) {
								...
								Element element = (Element) ((org.jsoup.nodes.Element) document).child(0);
								Elements scripts = ((org.jsoup.nodes.Element) element).getElementsByTag(Constants.SCRIPT_TAG);
